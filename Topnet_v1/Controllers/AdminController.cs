    ...
    public class AdminController : Controller
    {
        ...
        public ActionResult Index(string searchStringUserNameOrEmail, string currentFilter, int? page)
        {
            try
            {
             ...
             //   ViewBag.DataPoints =JsonConvert.SerializeObject(db.roleUser(), _jsonSetting);
        ...
        private ExpandedUserDTO GetUser(string paramUserName)
        {
            ...
            if (result == null) throw new Exception("Oon peut pas trouvé l'utilisateur");
        ...
        private ExpandedUserDTO UpdateDTOUser(ExpandedUserDTO paramExpandedUserDTO)
        {
            ...
            if (result == null)
            {
                throw new Exception("On peut pas trouvé l'utilisateur");
            }
        ...
        private UserAndRolesDTO GetUserAndRoles(string UserName)
        {
            ...
            {
                colUserRoleDTO.Add(new UserRoleDTO { RoleName = "Aucun role est trouvé" });
            }
        ...
        private List<string> RolesUserIsNotIn(string UserName)
        {
            ...
            if (user == null)
            {
                throw new Exception("l'utilsateur n'est pas trouvé");
            }
            ...
            {
                colRolesUserInNotIn.Add("Aucun role est trouvé");
            }
